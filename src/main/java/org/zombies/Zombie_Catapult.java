...
public class Zombie_Catapult extends Zombie implements SpecialAction {
     ...
     */
    public Zombie_Catapult(GamePanel gp, int healthPoint, int speed, int damage, int attack_speed) {
