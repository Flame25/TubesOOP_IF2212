...
public class Zombie_Snorkle extends Zombie implements SpecialAction {
     ...
     */
    public Zombie_Snorkle(GamePanel gp, int healthPoint, int speed, int damage, int attack_speed) {
