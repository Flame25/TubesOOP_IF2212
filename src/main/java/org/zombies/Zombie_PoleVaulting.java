...
import org.asset.SpecialAction;
import org.game.GamePanel;

import java.awt.*;

public class Zombie_PoleVaulting extends Zombie implements SpecialAction {
     ...
     */
    public Zombie_PoleVaulting(GamePanel gp, int healthPoint, int speed, int damage, int attack_speed) {
