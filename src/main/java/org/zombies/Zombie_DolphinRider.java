...
public class Zombie_DolphinRider extends Zombie implements SpecialAction {
     ...
     */
    public Zombie_DolphinRider(GamePanel gp, int healthPoint, int speed, int damage, int attack_speed) {
